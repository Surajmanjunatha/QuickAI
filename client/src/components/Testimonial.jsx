...
const Testimonial = () => {
  const dummyTestimonialData = [
    ...
    },
    {
      ...
      content:
        'QuickAI has significantly improved our workflow. The intelligent tools allow us to create engaging, professional content much more efficiently than before.',
      rating: 4,
    },
  ];
